...
* President's sequence method: 
      ...
      This is a special function that will be in your assignment. Try to create a method that iterates through the HashMap 
      in order. If you are not able to do so, try to figure out why and explain what is preventing you from doing so.

For these parts, it is highly recommended that you reference the Java API on HashMaps in order to gain a better understanding on which methods to use.
